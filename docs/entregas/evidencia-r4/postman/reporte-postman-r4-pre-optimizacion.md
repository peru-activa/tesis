...
Fecha de ejecución: 2026-09-04T02:36:40.500Z

Entorno de ejecución: despliegue AWS accesible en http://54.172.62.180:3100, Node.js v24.19.0 y PostgreSQL 17.
...
- Latencia promedio de las consultas: 240.980 ms.
- Mediana de latencia: 172.000 ms.
- Percentil 95 de latencia: 455.000 ms.
- Latencia máxima de las consultas: 926.000 ms.

## Evaluación

- El 100 % de los identificadores creados fue recuperado en la consulta final: **CUMPLE**.
- La latencia de cada consulta HTTP externa fue menor de 500 ms: **NO CUMPLE**.
