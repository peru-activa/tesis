...
export const WEEK_03_DATASET_VERSION = 'r5-synthetic-v15';
...
export const week03DeclaredWorkshops: Workshop[] = [
  {
    id: 'sim-workshop-a',
    displayName: 'Taller A · polos de algodón y deportivos',
    contactPhone: '900000001',
    products: ['polo'],
    poloTypes: ['cotton_basic', 'cotton_advertising', 'collared', 'sports'],
    materials: ['pima 20/1', 'pima 30/1', 'dry fit', 'win', 'zanetti'],
    ...
    productionRate: { quantity: 2000, days: 6 },
    minimumUnits: 20,
    maximumUnits: 2000,
    ...
    minimumLeadTimeDaysByProcess: { printing: 3 },
  ...
  {
    id: 'sim-workshop-b',
    displayName: 'Taller B · polos de algodón y deportivos',
    contactPhone: '900000002',
    products: ['polo'],
    poloTypes: ['cotton_basic', 'cotton_advertising', 'sports'],
    materials: ['pima 20/1', 'pima 30/1', 'dry fit', 'win', 'zanetti'],
    materialFamilies: ['cotton_knit', 'sports_knit'],
    materialMatchingMode: 'family',
    processes: [
  ...
  {
    id: 'sim-workshop-j',
    displayName: 'Taller H · polos publicitarios de algodón',
    contactPhone: '900000008',
    products: ['polo'],
    poloTypes: ['cotton_advertising'],
    materials: ['algodón publicitario', 'algodón pyme'],
    materialFamilies: ['cotton_knit'],
    materialMatchingMode: 'declared_only',
    processes: [
      'fabric_sourcing',
      'design',
      'patternmaking',
    ...
    capacityPlanningMode: 'throughput',
    capacityUnit: 'garments',
    productionRate: { quantity: 10000, days: 6 },
    minimumUnits: 20,
    maximumUnits: 10000,
...
export function recommendationForScenario(
  ...
  return recommendationRequestSchema.parse({
    ...
    order: {
      ...
      fabricBuyer,
      fabricSupply: fabricSupplyForPoloMaterial(material),
